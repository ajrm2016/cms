...
import com.ajrm.cms.dao.message.MessageRepository;
import com.ajrm.cms.dao.message.MessagesenderRepository;
import com.ajrm.cms.dao.message.MessagetemplateRepository;
import com.ajrm.cms.service.message.email.DefaultEmailSender;
import com.ajrm.cms.service.message.email.EmailSender;
...
public class MessageService extends BaseService<Message, Long, MessageRepository> {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(StringUtil.replace(template,"张三","cms"));
    }
